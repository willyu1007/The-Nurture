...
- Active tasks: T-002 (`C30-I0` and C30-I1-A/I1-B/I1-C accepted) and the
...
2. If T-002 remains the priority, separately authorize `C30-I1-D` scope review and
   freeze; no I1-D implementation is currently open. T-003 may close
