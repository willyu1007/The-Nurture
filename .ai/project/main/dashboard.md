...
- Active tasks: T-002 (`C30-I0` and C30-I1-A complete; I1-B1/B2 implemented/verified) and the
...
2. By current-status priority, separately authorize T-002 `C30-I1-B3` before any
   current-evidence/recovery source work; T-003 may close independently as a short
   design track.
