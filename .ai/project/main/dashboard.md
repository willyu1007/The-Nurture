...
- Active tasks: T-002 (`C30-I0` and C30-I1-A complete; I1-B1/B2/B3 implemented/verified) and the
...
2. By current-status priority, separately authorize T-002 `C30-I1-B4` before the
   cumulative build/conformance/source-lock seal; T-003 may close independently as
   a short design track.
