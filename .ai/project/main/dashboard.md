...
- Active tasks: T-002 (`C30-I0` and C30-I1-A/I1-B accepted; I1-C repair reopened) and the
...
2. If T-002 remains the priority, complete the authorized `C30-I1-C4` quality
   repair and successor qualification; I1-D is not eligible. T-003 may close
