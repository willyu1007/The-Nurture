...
- Active tasks: T-002 (`C30-I0` and C30-I1-A/I1-B/I1-C accepted; I1-D scope
  frozen with no source open) and the non-blocking T-003 artifact closeout.
...
2. If T-002 remains the priority, separately authorize `C30-I1-D1` contract and
   common-primitives implementation under artifact 28; D2-D5, manifest/source
