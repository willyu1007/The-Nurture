...
- Active tasks: T-002 (`C30-I0` and C30-I1-A/I1-B accepted; I1-C1-C3 complete) and the
...
2. Continue the authorized T-002 I1-C sequence with `C30-I1-C4` cumulative
   qualification/source-lock sealing; T-003 may close
