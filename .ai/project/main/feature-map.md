...
- Next Checkpoint: I4-C0 governance/design verification is complete. Begin
  I4-C1 by generating and reviewing an additive Prisma diff without applying
  it, and request target approval only after migration review.
