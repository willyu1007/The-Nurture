...
- Next Checkpoint: implement and qualify NestJS ingress M1→M3 with M4 interleaved,
...
- Next Checkpoint: T-004 Phase 0 与 T-002 NestJS ingress M0 已完成；当前单主线执行
  T-002 M1→M3（M4 交错），随后返回 T-004 Phase 1-2 形成可重建的
