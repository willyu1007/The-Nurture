...
- Next Checkpoint: T-005 G2 Exit is PASS at `nurture.surface-contract@1.8.0` /
  `sha256:4fe91e13…`, and T-006 G3-A additively rotated the current provider root
  to `nurture.surface-contract@1.9.0` / `sha256:d769e496…` without touching the
  shared core or any T-005 capability slice. The single critical lane advances to
  T-006 G3-B1 capture-to-draft; T-007 continues from G4-0C when it becomes the
  critical lane. All new capabilities remain default-off and external traffic
  remains NO-GO.
