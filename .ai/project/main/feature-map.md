...
- Next Checkpoint: preserve the exact T-005 G2 provider handoff while T-002 keeps broader
  C30-C35, C40-C45, D, Pilot-0-E and Pilot-1 readiness as separate gates. No
  downstream task may reinterpret G1/G2 PASS as deployment or traffic authority.
...
- Next Checkpoint: T-005 G2 Exit is PASS at `nurture.surface-contract@1.8.0` /
  `sha256:4fe91e13…`, and T-006 G3-A plus G3-B1 additively rotated the current
  provider root to `nurture.surface-contract@1.10.0` / `sha256:40fb7446…`
  without touching the shared core or any T-005 capability slice. The single
  critical lane advances to T-006 G3-C1 content/media safety; T-007 continues
  from G4-0C when it becomes the critical lane. All new capabilities remain
  default-off and external traffic remains NO-GO.
...
| T-006 nurture-child-care-boards | in-progress | dev-docs/active/nurture-child-care-boards |
