...
- Next Checkpoint: preserve the exact T-005 G2 and T-006 G3 handoffs. `C30-I0`
  ...
  Base-only B1/B2 are implemented/locally verified through `445c236…`. Separately
  authorize I1-B3 before current-evidence/recovery source work. Remaining I1-B, I1-C..F,
...
- Related Tasks: T-004 (`done`); T-005 (`archived`); T-006 (`done`);
  T-007～T-008 (`planned`).
- Next Checkpoint: T-006/G3 is closed at exact handoff `0374087…`. Choose whether
  to start T-007 at G4-0C; T-008 remains planned until the complete T-007 G4 Exit.
