...
- Related Tasks: T-010 nurture-family-sharing-eligibility (`in-progress`).
- Next Checkpoint: I4-C1 is drafted and independently reviewed (2026-08-12):
  additive authority/policy schema with composite-FK scope pinning, at-most-one
  active-slot partial uniques, a preview-only migration and the pinned-invariant
  verifier (`verify:family-sharing-invariants`). Next: I4-C2 current-authority
  reader over these records; database apply stays behind the C4
  approved-disposable gate and a separate durable approval.
...
| Task | Status | Dev Docs |
| --- | --- | --- |
| T-010 nurture-family-sharing-eligibility | in-progress | dev-docs/active/nurture-family-sharing-eligibility |
