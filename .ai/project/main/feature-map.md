...
- Stage G4: reuse T-007 and organize delivery as G4-0 Contract & Fact Freeze,
  ...
  retrieval/owner bridge plus cited-answer/safety contract; its audit/Exit and G4-E
...
- Current posture: T-007 completed 0C, 0D and the full frozen 0E chain at
  ...
  scope and all three unit freezes; its cross-contract audit/Exit remains open.
- Next Checkpoint: complete the 0F audit/Exit, then enter G4-E I1;
