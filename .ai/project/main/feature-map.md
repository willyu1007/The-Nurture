...
- Next Checkpoint: T-005 G2 Exit is PASS at `nurture.surface-contract@1.8.0` /
  `sha256:4fe91e13…`, and T-006 G3-A, G3-B1 and G3-C1 additively rotated the
  current provider root to `nurture.surface-contract@1.11.0` /
  `sha256:7da48739…` without touching the shared core or any T-005 capability
  slice. The single critical lane advances to T-006 G3-D publish/release;
  T-007 continues from G4-0C when it becomes the critical lane. All new
