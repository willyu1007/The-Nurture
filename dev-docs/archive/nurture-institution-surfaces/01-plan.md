...
- 0F scope and the exact generic My-Chat Knowledge/PBR/RAG source pin are
  ...
  lifecycle/provenance unit is frozen in
  [`65-g4-0f-1-knowledge-lifecycle-provenance-freeze.md`](./65-g4-0f-1-knowledge-lifecycle-provenance-freeze.md).
  Retrieval/owner bridge is frozen in
  [`66-g4-0f-2-retrieval-owner-bridge-freeze.md`](./66-g4-0f-2-retrieval-owner-bridge-freeze.md).
  Citation/answer safety and the immutable conflict-review candidate are frozen
...
- [x] Complete exact replay/response-loss plus revoke/expiry/head-drift across
  the admitted command matrix.
- [x] Add the separate Guardian/mobile/formalization carrier only with its
...
boundary, Prisma derivation and first real signed positive path. Record
[`95`](./95-g4-d-i4-exit-record.md) closes I4; G4-F remains the exact pin
reseal and task-level integration/handoff join.
