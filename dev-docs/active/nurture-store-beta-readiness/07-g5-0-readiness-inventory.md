...
| T-002 owner/source subset | `C30_CURRENT_PIN_REQUAL_PASS`; record 26 plus the 2026-08-14 W4 source-reseal addendum is authoritative (My-Chat `e0e5e93…`; `x5_joint_api=de1e840d…`; contract parity `85cf56e2…` and wave4 `65d6b0a0…` unchanged; C30 lock `2eb6f416…`) | T-002 record 26 + addenda; `docs/project/integrations/my-chat-workflow-contract.json`; `docs/project/integrations/c30-i3-owner-adoption-lock.json` |
...
| Final green shared-input sources | My-Chat `e0e5e937cb16b6b49e918656a4af214ddea41a48`; Nurture W4 `d5df447ff0ab33911396531e47775364e62b0e4f`; T-002 pin source `a9e1be9054e5a42e0e985bf491da13c1228b77c9`; lock commit `035d009b7a5501081f13b2d173242b1d18020e92` | Exact committed revisions after joint W4 verification and pin reseal; they are Freeze inputs, not a Candidate identity or activation |
