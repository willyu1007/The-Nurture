...
| Pilot-0 | The-Nurture governance + cross-repo review | Pilot-0-A/B and Pilot-0-C2 complete; C-3-0b ingress, C-3-0c presentation, and C-3-0d action execution/recovery planning complete; C-3-0e protected/offline/complete adoption is next | X5 | Readiness only; external traffic NO-GO; no DB, artifact publication, secret, capability, or traffic change |
...
当前阶段为 Pilot-0 readiness：X5、Pilot-0-A/B、Pilot-0-C2，以及 C-3-0b authenticated ingress、C-3-0c presentation、C-3-0d action execution/recovery planning 已完成。C-3-0d 以 `scenario_domain_action_execution_v1` 原子能力、静态 `nurture_direct_empty_v1|workflow_claimed_step_v1` driver、持久化不可 claim Step -> Nurture binding -> 开放 claim、Nurture 派生 effect identity、typed Participant actor、原子事务、same-Step replay ownership、独立 `scenario_domain_action_source_v1` 和三仓 conformance 关闭 action 设计门禁。`reply_family_care_item`、transfer proposal、family withdrawal 和 Institution service end 是 claimed-Step；Invitation、C-0、portability 和 Technical Operator 保持独立路径。以上仍是 planning-only，未满足实际三仓采用或 capability/allowlist 启用。C-3-0e、Guardian/Caregiver IIB、C-4 Institution IIB、topology/operations 和 Go/No-Go 仍待锁定。Pilot-1..4、live traffic、数据库 apply、ACR 发布、secret 配置、capability activation、staging、production 和 GA 均未授权。
