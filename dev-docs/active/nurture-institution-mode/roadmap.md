...
| D8 | IIA implementation entry | **LOCKED / N1 COMPLETE:** N1-A through N1-F pass: approved additive migration, CommandExecution/InteractionContext, resolver/policy, family-care transitions, DB-backed inbox/attention owner-read surfaces, manifest/module conformance, and explicit-empty activation | Hold non-empty activation; proceed through My-Chat X3, then X4/N2 behind capability gate |
