...
| Pilot-0 | The-Nurture governance + cross-repo review | Pilot-0-A/B complete; Pilot-0-C in progress with C-0 ingress/bootstrap and C-1 CareGroup/staff onboarding locked; C-2 family/child/enrollment/Grant next | X5 | Readiness only; external traffic NO-GO; no DB, artifact publication, secret, capability, or traffic change |
...
当前阶段为 Pilot-0 readiness：X5、Pilot-0-A/B 已完成。Pilot-0-C 的 C-0 与 C-1 已锁定：My-Chat-only public ingress、Nurture private authority、一次性 Institution bootstrap，以及由 Institution Admin 管理的唯一 `NurtureCareGroup` 班级对象、派生 readiness、Staff Invitation、accepted-user Participant binding、独立 Caregiver/Lead RoleAssignment 和 revoke/offboarding。班级没有第二套 lifecycle，家庭邀请在 active Institution/Group、有效 Lead Caregiver、完整 policy 和 Pilot gate 全部满足前 fail-closed。C-2 family-owned longitudinal child profile/Co-Guardian/Enrollment Invitation/Grant、后续 operational IIB、real cohort sizing、isolated topology、workspace allowlist、成功/停止和回滚仍待锁定。Pilot-1..4、live traffic、数据库 apply、ACR 发布、secret 配置、capability activation、staging、production 和 GA 均未授权。
