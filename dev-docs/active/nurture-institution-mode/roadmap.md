...
| Pilot-0 | The-Nurture governance + cross-repo review | Pilot-0-A complete; revised B1 locks three synthetic child/family scopes; B2-1 locks four guardians as `2 + 1 + 1`; B2-2 staff roles and later decisions remain open | X5 | Readiness only; external traffic NO-GO; no DB, artifact publication, secret, capability, or traffic change |
...
当前阶段为 Pilot-0 readiness：X5 与 Pilot-0-A 已完成；revised Pilot-0-B1 已锁定 one internal synthetic workspace / three child scopes / three independent families，B2-1 已锁定 guardian `2 + 1 + 1` 共四个独立账号。B2-2 institution/caregiver/operator、real cohort sizing、data class、IIB/onboarding、isolated topology、workspace allowlist、成功/停止和回滚仍待逐条锁定；Pilot-1..4、live traffic、数据库 apply、ACR 发布、secret 配置、capability activation、staging、production 和 GA 均未授权。
