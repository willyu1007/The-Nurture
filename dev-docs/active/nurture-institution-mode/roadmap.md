...
| Pilot-0 | The-Nurture governance + cross-repo review | Pilot-0-A complete; B1 progressive single-institution cohort locked; B2 roles/personnel and later IIB/topology/success-stop/rollback decisions remain open | X5 | Readiness only; external traffic NO-GO; no DB, artifact publication, secret, capability, or traffic change |
...
当前阶段为 Pilot-0 readiness：X5 与 Pilot-0-A 已完成；Pilot-0-B1 已锁定 progressive single-institution cohort（Pilot-3 synthetic，Pilot-4A 两个参与 child scopes，零 immediate-stop 后 Pilot-4B 扩到同组五至八个）。B2 roles/personnel、data class、IIB/onboarding、isolated topology、workspace allowlist、成功/停止和回滚仍待逐条锁定；Pilot-1..4、live traffic、数据库 apply、ACR 发布、secret 配置、capability activation、staging、production 和 GA 均未授权。
