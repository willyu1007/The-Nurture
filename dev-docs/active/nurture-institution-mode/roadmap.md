...
| Pilot-0 | The-Nurture governance + cross-repo review | Pilot-0-A complete; B1/B2 lock cohort/accounts; B3-0 locks role/surface entitlement; B3-1a locks Guardian actions; B3-1b-d and B3-2 through B3-4 remain open | X5 | Readiness only; external traffic NO-GO; no DB, artifact publication, secret, capability, or traffic change |
...
当前阶段为 Pilot-0 readiness：X5 与 Pilot-0-A 已完成；revised Pilot-0-B1/B2 已锁定 synthetic cohort 和七个逻辑账号，B3-0 已锁定 role/surface entitlement，B3-1a 已锁定 Guardian actions。B3-1b Caregiver、B3-1c Institution、B3-1d operator/action-key、B3-2 transition、B3-3 business/data、B3-4 journey coverage、real cohort sizing、IIB/onboarding、isolated topology、workspace allowlist、成功/停止和回滚仍待逐条锁定。Pilot-1..4、live traffic、数据库 apply、ACR 发布、secret 配置、capability activation、staging、production 和 GA 均未授权。
