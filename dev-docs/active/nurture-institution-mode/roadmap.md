...
当前阶段为 Pilot-0 readiness：X5 与 Pilot-0-A 已完成；revised Pilot-0-B1 已锁定 one internal synthetic workspace / three child scopes / three independent families，Pilot-0-B2 已锁定 guardian `2 + 1 + 1`、one institution admin、one lead caregiver、no backup caregiver、one technical operator，共七个逻辑账号。B3 business/data class、real cohort sizing、IIB/onboarding、isolated topology、workspace allowlist、成功/停止和回滚仍待逐条锁定；Pilot-1..4、live traffic、数据库 apply、ACR 发布、secret 配置、capability activation、staging、production 和 GA 均未授权。
