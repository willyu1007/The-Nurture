...
| D8 | IIA implementation entry | **LOCKED / X4 ENTRY:** N1-A through N1-F pass and My-Chat X3 is pinned at `4d40d81`; explicit-empty activation remains the current runtime posture | Create independent X4 branches, lock the first vertical slice, and keep capability unavailable until the X4 fault/privacy gates pass |
