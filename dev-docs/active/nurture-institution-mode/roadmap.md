...
| Pilot-0 | The-Nurture governance + cross-repo review | Pilot-0-A complete; B1 locks three synthetic child/family scopes; B2 locks seven logical accounts; B3-0 locks the role/surface matrix; B3-1 through B3-4 and later decisions remain open | X5 | Readiness only; external traffic NO-GO; no DB, artifact publication, secret, capability, or traffic change |
...
当前阶段为 Pilot-0 readiness：X5 与 Pilot-0-A 已完成；revised Pilot-0-B1 已锁定 one internal synthetic workspace / three child scopes / three independent families，Pilot-0-B2 已锁定七个逻辑账号。B3 已重拆为 B3-0 role/surface、B3-1 action、B3-2 transition、B3-3 business/data、B3-4 journey coverage；B3-0 已锁定，B3-1 至 B3-4、real cohort sizing、IIB/onboarding、isolated topology、workspace allowlist、成功/停止和回滚仍待逐条锁定。Pilot-1..4、live traffic、数据库 apply、ACR 发布、secret 配置、capability activation、staging、production 和 GA 均未授权。
