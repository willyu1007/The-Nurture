...
| Pilot-0 | The-Nurture governance + cross-repo review | Pilot-0-A complete; B1/B2 lock cohort/accounts; B3-0 locks role/surface entitlement; B3-1a/B3-1b/B3-1c lock Guardian/Caregiver/Institution actions; B3-1d and B3-2 through B3-4 remain open | X5 | Readiness only; external traffic NO-GO; no DB, artifact publication, secret, capability, or traffic change |
