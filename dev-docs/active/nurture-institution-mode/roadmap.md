...
当前阶段为 Pilot-0 readiness：X5 与 Pilot-0-A 已完成；revised Pilot-0-B1/B2 已锁定 synthetic cohort 和七个逻辑账号，B3-0 已锁定 role/surface entitlement，B3-1a/B3-1b/B3-1c 已锁定 Guardian/Caregiver/Institution actions，B3-1d-0 已锁定 key layering 和六个现有 family-care mapping。B3-1d-1 operator permissions、B3-1d-2 remaining mappings、B3-1d-3 reasons/gates、B3-2 transition、B3-3 business/data、B3-4 journey coverage、real cohort sizing、IIB/onboarding、isolated topology、workspace allowlist、成功/停止和回滚仍待逐条锁定。Pilot-1..4、live traffic、数据库 apply、ACR 发布、secret 配置、capability activation、staging、production 和 GA 均未授权。
