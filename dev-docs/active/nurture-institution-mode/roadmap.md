...
| --- | --- | --- |
| T-002 C30 current pins | `C30_CURRENT_PIN_REQUAL_PASS`, default-off; Base `536638a`, My-Chat `42c94825`, Nurture `a6727df`, record 25 | Preserve exact source/schema/default-off locks; no activation. |
