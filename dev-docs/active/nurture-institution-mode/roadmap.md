...
| Pilot-0 | The-Nurture governance + cross-repo review | Pilot-0-A and Pilot-0-B complete; B1/B2 and B3-0 through B3-4 locked; Pilot-0-C IIB/onboarding contract next | X5 | Readiness only; external traffic NO-GO; no DB, artifact publication, secret, capability, or traffic change |
...
当前阶段为 Pilot-0 readiness：X5、Pilot-0-A 与 Pilot-0-B 已完成。Revised B1/B2 和 B3-0 至 B3-4 均已锁定；B3-4 要求完整 action/surface conformance、三个 child scope 上四条代表性业务闭环、Institution/Operator 独立链路、分层 fault/privacy matrix，以及连续三次高风险 joint 证据。Pilot-0-C IIB/onboarding、real cohort sizing、isolated topology、workspace allowlist、成功/停止和回滚仍待逐条锁定。Pilot-1..4、live traffic、数据库 apply、ACR 发布、secret 配置、capability activation、staging、production 和 GA 均未授权。
