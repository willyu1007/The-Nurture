...
| D8 | IIA implementation entry | **X4-A COMPLETE / X4-B READY:** claimed-Step replay seeds pass 157 unit and 23 DB/E2E tests on an approved disposable DB; My-Chat X3 remains pinned at `4d40d81`; advertised runtime remains explicit-empty | Implement the trusted My-Chat driver/snapshot bridge, then review before any manifest or capability activation |
