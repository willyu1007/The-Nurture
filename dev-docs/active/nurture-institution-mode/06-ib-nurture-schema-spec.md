...
- C-2f-0 defines no persistence migration, action key, result vocabulary, Handoff, notification, or provider effect. C-2f-1 through C-2f-5 must separately lock those mechanics before implementation or traffic.
