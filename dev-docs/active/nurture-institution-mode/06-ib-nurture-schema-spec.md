...
- C-3-0b-1 is planning-only. C-3-0b-2 owns the exact private service/principal envelope, C-3-0b-3 owns Notification/worker/prospective/operator path mechanics, and C-3-0b-4 owns codecs, denial/audit, additive adoption, and closure evidence. No contract, invitation model, manifest, source, schema, migration, route, runtime, secret, environment, capability, provider, database, or traffic changed.
