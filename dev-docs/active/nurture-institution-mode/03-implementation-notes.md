...
- 2026-07-16: Locked Pilot-0-B1 after owner acceptance. Pilot-3 remains internal/test-account/synthetic-data rehearsal only. Pilot-4A targets one invited institution and one care group with two explicitly participating family child scopes; only a zero-immediate-stop 4A result may expand Pilot-4B to five through eight participating scopes in the same group. A second institution, whole-group default enrollment, self-service enrollment, and non-consenting child scopes are excluded. Child identity/data remain minimized. This decision locks cohort nature and staged size only; B2 roles/personnel and later data-class decisions remain open, and no real traffic or later Pilot phase is authorized.
