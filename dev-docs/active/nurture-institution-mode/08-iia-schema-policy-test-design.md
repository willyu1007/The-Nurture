...
- Planning-boundary tests MUST prove C-3-0b-1 changes task documentation only. Private service/principal wire semantics remain C-3-0b-2, exact path variants remain C-3-0b-3, and codec/denial/audit/adoption evidence remains C-3-0b-4. No contract, invitation model, manifest, source, schema, route, runtime, secret, environment, capability, provider, database, or traffic change exists.
