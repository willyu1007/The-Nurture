...
- Planning-boundary tests MUST prove C-2f-4-0 changes no schema/source/runtime/manifest/database/traffic, leaves versioned stage facts and exact Guardian lifecycle to C-2f-4-1, leaves remaining cross-Institution privacy/future-protocol detail to later C-2f-4 checkpoints, and leaves exact result/presenter/notification/Handoff/delivery to C-2f-5.
