...
- Planning-boundary tests MUST prove C-2f-4-0 changes no schema/source/runtime/manifest/database/traffic; the following C-2f-4-1 locks versioned stage facts and exact Guardian lifecycle, C-2f-4-2/3 retain cross-Institution privacy/future-protocol detail, and C-2f-5 retains exact result/presenter/notification/Handoff/delivery.
...
- Planning-boundary tests MUST prove C-2f-4-1 changes no schema/source/runtime/manifest/database/traffic, leaves family/Institution visibility and multi-Institution concurrency to C-2f-4-2, future cross-workspace protocol boundary to C-2f-4-3, and exact result/presenter/notification/Handoff/delivery to C-2f-5.
