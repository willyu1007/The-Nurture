...
- Planning-boundary tests MUST prove C-2f-4-2 changes no schema/source/runtime/manifest/database/traffic, adds no dataClass/action/route/shared projection, leaves future cross-workspace protocol boundary to C-2f-4-3, and leaves exact result/presenter route/notification/Handoff/delivery to C-2f-5.
