...
- Overall state: `C30_I1_IN_PROGRESS / I1_A_ACCEPTED / I1_B_ACCEPTED / I1_C_ACCEPTED / I1_D_ACCEPTED`
...
| `C30-I1-D` domain action | Prepare/submit, direct-empty versus claimed-Step driver, result/recovery and canonical effect-identity inputs. | I1-C accepted. | **Accepted:** artifacts 28-33 bind D1-D5 through Base source `52c0dc2…`, lock `c179bb5…`, hash `50c5fa16…f093`; I1-F retains manifest/source convergence. |
