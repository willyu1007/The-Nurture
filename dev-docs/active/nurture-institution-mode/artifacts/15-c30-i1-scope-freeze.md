...
| `C30-I1-C` subject presentation | Subject-context discovery/resolve, semantic presentation, navigation/action offers and safe owner text. | I1-B accepted. | **Ready / not started:** separate scope review/freeze authorization required; presentation types/codecs/Schemas/bounds/fixtures remain future work. |
