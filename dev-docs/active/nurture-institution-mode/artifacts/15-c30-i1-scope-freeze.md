...
- Overall state: `C30_I1_IN_PROGRESS / I1_A_ACCEPTED / I1_B_ACCEPTED / I1_C_SCOPE_FROZEN`
...
| `C30-I1-C` subject presentation | Subject-context discovery/resolve, semantic presentation, navigation/action offers and safe owner text. | I1-B accepted. | **Scope frozen / implementation not started:** exact types, codecs/Schemas, bounds, fixtures and ordered C1-C4 units are frozen in artifact 21; C1 requires separate authorization. |
