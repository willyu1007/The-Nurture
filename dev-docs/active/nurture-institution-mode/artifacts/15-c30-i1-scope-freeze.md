...
| `C30-I1-D` domain action | Prepare/submit, direct-empty versus claimed-Step driver, result/recovery and canonical effect-identity inputs. | I1-C accepted. | **Scope frozen / source not authorized:** artifact 28 defines D1-D5, `scenario_direct_empty_v1|workflow_claimed_step_v1`, scenario-bound direct/claimed identity and I1-F manifest/source deferral. |
