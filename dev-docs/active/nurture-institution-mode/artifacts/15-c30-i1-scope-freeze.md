...
| `C30-I1-B` canonical-object binding envelope | Neutral typed owner refs, reservation, pair-binding request/result/recovery and current-owner evidence without platform Child/Family policy. | I1-A accepted. | **Scope frozen / ready-not-started** in `16-c30-i1-b-scope-freeze.md`; binding wire/codecs/Schemas must pass before acceptance, while owner semantics remain I2/I3. |
