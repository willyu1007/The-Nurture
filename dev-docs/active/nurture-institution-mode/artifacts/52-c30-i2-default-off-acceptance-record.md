...
| My-Chat | task registration `500a75edfda47f64163d1baa781b0b7f3cb1e941`; I2-A `470fc862895e1536c624be76b64e5bd8e2d49991`; I2-B `7aca47febc340ae58fcd3d4d8f8feaaeae6b2795`; I2-C `5fd7b082c53cec7c5ed613f63d78cb6660ae55a2`; I2-D `82f97f392a79a832ebed445567cf8c76137ddc84`; I2-E `1ef31d404c1456bdd53964837da8f7d54b50d782`; I2-F `979ba42d915ff18abc4644a68427ebb6d56a34e2`; I2-G runtime `35a41e3becaecba920772251b77a09119687affa`; downstream lock `890ff7dd6da4911dfefe77723cce0a7bc62ebb7e`; qualification repair `c8af30756548600057c7b4af4572b41f2572b797`; acceptance `1bf52be9c97480afd9f20d43a4e1db939bd0cddc`; archive `b262bfc9ec05fd17f23533749643512e6002e24d` | Exact generic Host implementation, deterministic lock and default-off acceptance under My-Chat T-035. |
...
My-Chat's downstream aggregate is
`3da48ba032296ada5b7e5577de551a883c6d97f74cb0680ad2f02eb91f6b9646`
over exact runtime revision `35a41e3becaecba920772251b77a09119687affa`.
Its seven named profiles are:

| Profile | Hash |
| --- | --- |
| Trusted invocation runtime | `eab243e3e96af35ecef8c3694ea0c2c1ede63746b0fe09a03a3b9e2703b93466` |
| Canonical pair runtime/schema | `b360845247ef22dd9ff6bae7becfc132ee717ee53eeeeb84f19fee34edf491d7` |
...
| Protected runtime | `4d656d2ed9dac2b3ca10b5a5fd643de4dd3457365e8232124b2f617c74f583d9` |
| Adoption registry | `6cdb5937f032128a6acd2bf864775812cdfa15410cc8bbac07f7cf4d45a83cf7` |
| Qualification tests | `55980fb984705a014754a51cc3c14690b1a45b164514e8ff2315048803181a54` |
...
- Full workspace build passes across 17 participating projects. The Admin build
  used ephemeral loopback-only synthetic Logto values and contacted no service.
- Recursive workspace typecheck and full ESLint pass. The exact byte-locked Base
  source remains unchanged; the local lint exception documents that boundary.
- The unit population passes 102 files / 643 tests. Seventeen files / 73 tests
  requiring unrelated external environments remain intentionally skipped.
- Workflow contract build, 66-Schema compilation, claim-token boundary, Base
  source lock and portability checks pass.
- Workflow runtime adoption passes 12 files / 176 tests, including registry
  drift and all default-off negative categories.
- Strict context and project-governance checks pass. Repository docs lint has
  zero errors; its 230 warnings predate T-035 and none is introduced by that
  task.

## Disposable database evidence

The authorized disposable target was exactly PostgreSQL 16 with pgvector on
`127.0.0.1:55438`, container `mychat-c30-i2-disposable`, database
`mychat_c30_i2`.

1. The port and container were absent before creation.
2. Prisma format, validate and generate passed.
3. All 26 migrations applied from an empty database; migration status was
   current and DB-to-SSOT diff was empty.
4. The combined nonce and pair integration population passed 15/15 three
   consecutive times.
5. Final C30 capability, capability-setting, capability-run, Nurture Scenario,
   nonce and pair-operation row counts were all zero.
6. Nonce and pair tables contain no body, payload, result, plaintext,
   ciphertext or protected-data columns.
7. The exact disposable container was destroyed and port 55438 was free.
...
- Workspace allowlists, product bindings, route registrations and production
  peer bindings are empty; external traffic is zero.
...
and its immutable source/lock chain is the rollback boundary. The only eligible
successor is a separately authorized `C30-I3` scope review. This record does not
