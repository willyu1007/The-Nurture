...
| Pilot-0-B cohort/role/surface/data lock | In progress — through B3-2a locked | Revised B1/B2 and B3-0/B3-1 are locked; B3-2a locks transition/destination semantics. B3-2b-d and B3-3/B3-4 remain open. |
