...
| Pilot-0-C IIB/onboarding contract | In progress — C-2f-3c locked | C-2f-3c locks same-Institution fresh re-entry through existing action keys, all-new relationship identities, one generalized predecessor lineage, terminal-leaf/current-owner preconditions, atomic confirmation, episode-separated history, and zero old authority revival. C-2f-4 next-stage/cross-scope portability is next. |
