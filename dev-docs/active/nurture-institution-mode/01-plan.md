...
| Pilot-0-C IIB/onboarding contract | In progress — C-2f-4-0 locked | C-2f-4-0 separates the same-workspace longitudinal ChildCareProcess, family-owned stage episode, Institution-local Enrollment episode, and workspace privacy boundary. Different-Institution entry is independent fresh onboarding with no cross-Institution lineage or authority carryover; stage change is Enrollment-independent; cross-workspace reuse/inference/migration is Pilot `NO-GO`. C-2f-4-1 stage fact/authority/lifecycle is next. |
