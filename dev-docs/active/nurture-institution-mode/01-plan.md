...
| Pilot-0-C IIB/onboarding contract | In progress — C-2f-2 locked | C-2f-2 adds Institution-proposed/family-confirmed TransferIntent, explicit action keys, zero-hold precondition, target-on-confirm roster, one-way Enrollment lineage, database-time atomic cutover, complete old Grant/work closure, and zero old authority/content transfer. C-2f-3 permanent exit/re-entry is next. |
