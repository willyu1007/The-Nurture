...
| Pilot-0-B cohort/role/surface/data lock | In progress — through B3-1d-2 locked | Revised B1 locks the cohort; B2 locks seven accounts; B3-0/B3-1a-c lock surfaces/actions; B3-1d-0 through B3-1d-2 lock key layers, operator permissions, and exact remaining domain mappings. B3-1d-3 and B3-2 through B3-4 remain open. |
