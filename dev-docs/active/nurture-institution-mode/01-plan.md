...
| Pilot-0-B cohort/role/surface/data lock | In progress — B3-3a locked | Revised B1/B2, B3-0/B3-1, and B3-2a-d are locked; B3-3a fixes the first `family_care_question` input/data envelope and Pilot profile gate. B3-3b-d and B3-4 remain open. |
