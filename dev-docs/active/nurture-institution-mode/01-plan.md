...
| Pilot-0-C IIB/onboarding contract | In progress — through C-2b-3 locked | C-2b-3 gives both current Guardians equal base family rights and current owner-reread of eligible committed history while preserving exact authorship, Grant-owner administration, original-Grant cross-role fences, draft isolation, and recipient-bound notification semantics. No history copy/backfill or revoked/redacted revival occurs. C-2b-4 relationship exit/revoke is next. |
