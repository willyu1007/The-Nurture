...
| Pilot-0-B cohort/role/surface/data lock | In progress — B3-3a/b locked | Revised B1/B2, B3-0/B3-1, and B3-2a-d are locked; B3-3a fixes the first input/data envelope and B3-3b fixes one exact bidirectional Grant plus family authority/target scope. B3-3c/d and B3-4 remain open. |
