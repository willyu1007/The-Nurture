...
| Pilot-0-B cohort/data-class lock | In progress — B1 locked | Progressive single-institution cohort is locked: Pilot-3 synthetic; Pilot-4A two participating child scopes; Pilot-4B gated expansion to five through eight scopes in the same care group. Role/personnel and business/data-class decisions remain open. |
