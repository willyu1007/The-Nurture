...
| Pilot-0-C IIB/onboarding contract | In progress — C-2d-1 locked | C-2d-1 fixes exact-recipient/current-Guardian strong confirmation and the indivisible submit-context/Execution/Enrollment/roster-link/invitation-consume/audit core without implicit Grant. C-2d-2 lifecycle and concurrency is next; thread timing and result/Handoff remain later C-2d decisions. |
