...
| Pilot-0-C IIB/onboarding contract | In progress — through C-2b-2 locked | C-2b-1 locks first-Guardian establishment. C-2b-2 allows any current Guardian to initiate an exact-family/child/recipient Co-Guardian Invitation; acceptance rechecks inviter authority and exact Pilot topology before atomically binding/reusing Participant plus second Guardian role. Pilot executes one invitation for Family-1 only; no Schema/product count limit is introduced. C-2b-3 rights/history is next. |
