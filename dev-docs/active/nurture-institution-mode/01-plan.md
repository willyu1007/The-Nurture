...
## C30-I1 — Neutral shared contracts（I1-A/I1-B 已验收）
...
| `C30-I1-C` subject presentation | Ready / not started | I1-B accepted. Separate scope review/freeze authorization is required before source work. |
