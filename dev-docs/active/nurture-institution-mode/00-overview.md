...
- **Updated:** 2026-07-19
- **Owner:** willyu1007
- **Next step:** Continue Pilot-0-C3-0c-3 renderer/persistence classes after C-3-0c-2 locked read-only semantic presentation. `present_subject_context` returns only `ready|empty|context_changed|unavailable`; Nurture emits owner-localized BCP-47 plain text, six flat generic block kinds, separate navigation offers, and entitled durable-action offers. My-Chat never interprets reason/action codes, creates actions, or translates Nurture copy. Unavailable actions are shown only when the adult may know the action and target exist; existence-sensitive actions are omitted. AI receives only `narration=allowed` safe text after refs, versions, codes, cursors, and action targets are stripped. The response is capped at 64 KiB, 20 blocks/entries, 8 actions/navigation offers, and five-minute cursor/item/continuation/action-target refs. Draft/confirmation execution remains C-3-0d; protected bodies/media/offline remain C-3-0e. This checkpoint is planning-only: no contract, manifest, source, schema, migration, route, UI, renderer, runtime, cache, secret, capability, provider, database, or traffic changed. C-3-0c-3 through C-3-0e, Guardian/Caregiver IIB, C-4 Institution IIB, topology/operations, and final Go/No-Go remain open. Pilot-1 through Pilot-4 and all external enablement remain separately unauthorized.
