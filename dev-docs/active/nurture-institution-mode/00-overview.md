...
- **Updated:** 2026-07-18
- **Owner:** willyu1007
- **Next step:** Continue Pilot-0-C3-0b authenticated My-Chat ingress and trusted-principal boundary after C-3-0a locked Account–Subject reachability. My-Chat's user-facing business catalog converges on education and nurture while reusable platform capabilities remain subject-neutral. Every activated business scenario must start from an authenticated My-Chat account and let its owner resolve an authoritative relationship path to `unresolved|single_subject|subject_collection`; Nurture maps those contexts through Participant, RoleAssignment, Family, CareGroup, Enrollment, and ChildCareProcess. My-Chat may aggregate only workspace/scenario-bound opaque subject entries for discovery and navigation and owns no canonical child or relationship. No established relationship path means no ordinary subject presentation/action context; a prospective invitation exposes only minimum invitation context and the exact separately authorized onboarding action. Subject context grants no cross-workspace/cross-scenario identity link, bulk authority, or child login. This checkpoint is planning-only: exact wire fields remain C-3-0c/Base work, and no manifest, source, schema, runtime, database, capability, provider, or traffic changed. C-3 Guardian/Caregiver IIB, C-4 Institution IIB, topology/operations, and final Go/No-Go remain open. Pilot-1 through Pilot-4, database apply, ACR publication, secret configuration, capability activation, external traffic, staging, production, and GA remain closed until separate approval.
