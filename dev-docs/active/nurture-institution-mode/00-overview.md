...
- **Updated:** 2026-07-18
- **Owner:** willyu1007
- **Next step:** Continue Pilot-0-C2e-2 atomic Grant/Thread identity, time, expiry, duplicate, and concurrency convergence after C-2e-1 locked Grant review and confirming-Guardian authority. Any current exact-family Guardian may first confirm; the first committed confirmer becomes the sole Grant owner, while other current Guardians may use the active Grant but cannot replace/revoke. All three Guardian surfaces converge on one product-level strong confirmation with mandatory child/Institution/CareGroup/direction/duration/owner/revoke-retention/exclusion disclosure and a five-minute exact-actor/surface `submit_action` context. Natural-language intent, navigation, raw ids, client fields, expired/copied context, or Enrollment confirmation cannot authorize Grant creation. Existing exact active Grant resolves as current state or `already_satisfied` without owner transfer. Transfer/exit stays C-2f. Guardian/Caregiver operational IIB, topology/operations, and final Go/No-Go remain open. Pilot-1 through Pilot-4, database apply, ACR publication, secret configuration, capability activation, external traffic, staging, production, and GA remain closed until separate approval.
