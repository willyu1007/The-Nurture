...
- **Updated:** 2026-07-19
- **Owner:** willyu1007
- **Next step:** Continue Pilot-0-C3-0b-1 public ingress, session, and workspace-establishment boundary after C-3-0b-0 locked the trusted-principal trust model. My-Chat is the only public business ingress and proves the current adult account, human actor, exact validated workspace, registered scenario/surface provenance, and request evidence; a separately authenticated My-Chat service caller carries that principal to private Nurture. Neither identity conveys a Nurture role, Subject, Grant, policy decision, or action authority. Nurture maps the account to Participant and current RoleAssignment/Subject on every request, while service identity, Technical Operator, workspace membership, surface, and client claims cannot impersonate a business actor. Invitation acceptance remains a separate Host identity/membership transition before ordinary subject-aware ingress. Existing optional actor/workspace scaffold stays legacy-only; the activated path cannot infer workspace from Nurture data or persist/log bearer, service, or scenario tokens. This checkpoint is planning-only: exact public route/session/workspace semantics remain C-3-0b-1, exact private envelope names remain C-3-0b-2, and no contract, manifest, source, schema, runtime, database, secret, capability, provider, or traffic changed. C-3 Guardian/Caregiver IIB, C-4 Institution IIB, topology/operations, and final Go/No-Go remain open. Pilot-1 through Pilot-4, database apply, ACR publication, secret configuration, capability activation, external traffic, staging, production, and GA remain closed until separate approval.
