...
- **Updated:** 2026-07-19
- **Owner:** willyu1007
- **Next step:** Continue Pilot-0-C3-0c subject-aware presentation contract after C-3-0b-4 completed the authenticated-ingress planning boundary. Client input is now an exact discriminated `ScenarioClientEchoV1`; signing preserves bytes but never upgrades client authority. User text/view/token/action inputs are schema-bound, while User/Actor/Workspace, route/ingress, request/driver evidence, authentication-assurance evidence, and Notification/Invitation/Run/Step/Handoff refs remain Host-established. Participant/role/Subject/scope/Grant/policy/availability and the canonical business-effect identity/hash/replay decision remain Nurture-validated under the registered operation/driver contract. The client cannot author `command_request_id`; C-3-0d must lock exact direct-empty and claimed-Step derivation rules before implementation. Host ingress states and existing Nurture safe reasons remain separate from HTTP/protocol failures; private verification defects collapse to generic unavailable. Audit is owner-split and body-free: nonce hashes at most 5 minutes, traces 7 days, logs 14 days, aggregate metrics and ordinary ingress audit 90 days, and provisioning/operator/owner-recovery audit 365 days. Business facts/content remain under Nurture retention and the later protected-data gate. Base -> My-Chat -> Nurture adoption is additive, exact-revision/hash pinned, capability/default-off, negative-conformance-gated, and cannot fall back to legacy fields/routes. This checkpoint is planning-only: no contract, manifest, source, schema, migration, route, runtime, audit sink, secret, capability, provider, database, or traffic changed. C-3-0c/d/e, Guardian/Caregiver IIB, C-4 Institution IIB, topology/operations, and final Go/No-Go remain open. Pilot-1 through Pilot-4 and all external enablement remain separately unauthorized.
