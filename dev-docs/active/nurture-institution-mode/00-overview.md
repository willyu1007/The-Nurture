...
- **Updated:** 2026-07-18
- **Owner:** willyu1007
- **Next step:** Continue Pilot-0-C2f-3 permanent withdrawal/end/re-entry convergence after C-2f-2 locked same-Institution CareGroup transfer. Transfer is a new `NurtureEnrollmentTransferIntent`, not an Enrollment Invitation or direct topology write: Institution workbench proposes/cancels, any current exact-Family Guardian confirms/declines on Guardian surfaces, and five-minute strong confirmation is mandatory. Intent is seven days, fixed `care_group_transfer`, one effective pending per source Enrollment, no raw contact/free text, and stale after any source Enrollment version change. Proposal and confirmation require zero active pause holds; transfer cannot consume a hold. Additive exact `rosterEntryId`, unique new-to-old `supersedesEnrollmentId`, terminal reason/Execution, and target Roster creation at confirmation produce an auditable cutover without in-place `careGroupId` edit or mirrored successor. One Serializable transaction uses one database time to end old Enrollment, terminalize old Grants through C-2e closure, archive old Thread/source roster, create target roster/new active Enrollment, consume intent, and persist Execution; hard-cap/fault rolls back all. Target Group must be active/ready; source Group may be active/paused/archived for transfer-out. No Grant, Thread, content, work, policy, hold, context, notification, or Handoff authority transfers. C-2f-3 now owns Guardian withdrawal, Institution end, terminal reason/actor rules, hold closure, and fresh re-entry. C-2f-4/C-2f-5, operational IIB, topology/operations, and final Go/No-Go remain open. Pilot-1 through Pilot-4, database apply, ACR publication, secret configuration, capability activation, external traffic, staging, production, and GA remain closed until separate approval.
