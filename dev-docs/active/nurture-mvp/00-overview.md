...
- State: in-progress
- Next step: retire the obsolete repo-local UI governance toolchain and verify the first independent G0 increment.
- Updated: 2026-07-13
...
- [ ] My-Chat/Base contract revisions and hashes are machine-verifiable.
