...
- publication-policy rows created by qualification: 62;
- invalid policy contracts: 0;
- activation-like tables: 0.

There were 34 `PublicationRelease` test rows: 24 with Receipts and 10 deliberately
...
- CareItems: `harness_g2_v1=68`, `legacy_v1=11`;
- Messages: `harness_g2_v1=97`, `legacy_v1=12`;
...
The `the-nurture-g3-exit-9e024de` container and its tmpfs were destroyed after the
...
After the final static pin/G2/G3/formal-ingress rerun passed, the detached worktree
topology was moved to Trash as `the-nurture-g3-exit-97eab03` and is recoverable there.
