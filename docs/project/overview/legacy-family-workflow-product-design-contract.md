# [SUPERSEDED] Nurture Family Workflow Product Design Contract

> Historical initialization/product exploration preserved for traceability.
> Superseded on 2026-07-29 by
> `docs/context/product/workflow-product-design-contract.md`.
> The content below MUST NOT be used as the current Workflow, surface, or
